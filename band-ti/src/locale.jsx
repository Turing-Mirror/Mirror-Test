...
const COPY = {
  sc: {
    ...
    galleryTitle: "{characters} 名角色，都会在首页轮换展示。",
    ...
    close: "关闭",
    footerMoreTests: "发现更多测试", socialTitle: "关注图灵镜", socialCopy: "在图灵镜的社媒账号获取新测试、产品与项目动态。",
  },
  tc: {
    ...
    galleryTitle: "{characters} 名角色，都會在首頁輪換展示。", galleryCopy: "涵蓋 {series} 部少女樂隊動畫與 {bands} 組樂隊或音樂組合。點開角色卡即可前往對應的萌娘百科頁面。", bandFilter: "篩選樂隊", wiki: "查看角色 Wiki",
    ...
    communityTitle: "圖靈鏡 QQ 社群", communityHint: "點擊複製群號，或使用 QQ 掃碼加入", communityCopied: "已複製群號", communityCopy: "複製群號", previewTitle: "結果圖預覽", previewHint: "長按或保存圖片即可分享給朋友。", close: "關閉", footerMoreTests: "發現更多測驗", socialTitle: "關注圖靈鏡", socialCopy: "在圖靈鏡的社群帳號取得新測驗、產品與專案動態。",
  },
  en: {
    ...
    galleryTitle: "All {characters} characters rotate on the home page.", galleryCopy: "Across {series} girl-band anime series and {bands} bands or music groups. Open any card for its Moegirl Wiki page.", bandFilter: "Filter by band", wiki: "Open character Wiki",
    ...
    communityTitle: "Turing Mirror QQ Community", communityHint: "Copy the group number or scan with QQ to join", communityCopied: "Group number copied", communityCopy: "Copy group number", previewTitle: "Poster preview", previewHint: "Save or long-press the image to share it.", close: "Close", footerMoreTests: "Discover more tests", socialTitle: "Follow Turing Mirror", socialCopy: "Find new tests, products, and project updates on Turing Mirror social channels.",
  },
  ja: {
    ...
    galleryTitle: "{characters} 人のキャラクターをホームで順番に表示します。", galleryCopy: "{series} 作品、{bands} 組のバンド・音楽ユニットを収録。カードから萌娘百科のページを開けます。", bandFilter: "バンドで絞り込む", wiki: "キャラクター Wiki を開く",
    ...
    communityTitle: "Turing Mirror QQ コミュニティ", communityHint: "番号をコピーするか、QQ で QR を読み取って参加", communityCopied: "グループ番号をコピーしました", communityCopy: "番号をコピー", previewTitle: "結果画像プレビュー", previewHint: "画像を保存または長押しして共有できます。", close: "閉じる", footerMoreTests: "ほかのテストを見る", socialTitle: "Turing Mirror をフォロー", socialCopy: "新しい診断、プロダクト、プロジェクトの更新は公式 SNS で確認できます。",
  },
};
